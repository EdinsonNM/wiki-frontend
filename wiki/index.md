...
- [Clean Architecture Frontend](architecture/frontend-clean-architecture.md): hub de lectura gradual para capas, dependencias, responsabilidades, adopcion incremental del arquetipo, datos, hooks y UI.
