...
| --- | --- | --- | --- | --- |
| Codex | `AGENTS.md` | `.agents/skills` | `.agents/subagents` | `.agents/commands` |
| Cursor | `AGENTS.md`, `.cursor/rules/*.mdc` | `.cursor/skills` experimental | no nativo estable | `.cursor/commands/*.md` |
